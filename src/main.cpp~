...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1470000); // RUBLE: 1470k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1.5 * 24 * 60 * 60; // RUBLE: 1.5 days
static const int64 nTargetSpacing = 1.5 * 60; // RUBLE: 1.5 minutes
...
unsigned char pchMessageStart[4] = { 0xc4, 0xd3, 0xd2, 0xbd }; // RUBLE: increase each by adding 2 to bitcoin's value.
